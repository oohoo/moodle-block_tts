...
function SoundManager(smURL, smID) {
  ...
  this.debugFlash = true;           // enable debugging output inside SWF, troubleshoot Flash/browser issues
  ...
  this.useGlobalHTML5Audio = false;   // (experimental) if true, re-use single HTML5 audio object across all sounds. Enabled by default on mobile devices/iOS.
